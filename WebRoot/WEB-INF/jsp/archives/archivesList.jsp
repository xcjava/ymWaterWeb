...
<body>
			    ...
			    <table cellSpacing=0 cellPadding=2 border=0>
			      <tbody>
				      ...
				      <tr>
				        ...
				        <td>经济类型</td>
				        <td><select id="" name=""><option value=0 selected>全部状态</option> <option value=1>新申请</option> <option value=2>审核通过</option> <option value=3>审核未通过</option></option></td>
				        <td>产业分类</td>
				        <td><select id="" name=""><option value=0 selected>全部状态</option> <option value=1>新申请</option> <option value=2>审核通过</option> <option value=3>审核未通过</option></option></td>
    ...
    <table class="ymlistTable" width="100%" cellpadding="0" cellspacing="1" >
      <tr class="listTableHead">
        ...
        <td width="10%"><div><span>产业分类</span></div></td>
        <td width="15%"><div><span>客户编号</span></div></td>
        <td width="14%"><div><span>客户姓名</span></div></td>
        <td width="16%"><div><span>余额</span></div></td>
        <td width="27%"><div><span>经济类型</span></div></td>
        <td width="14%"><div><span>收费单位</span></div></td>
      </tr>
