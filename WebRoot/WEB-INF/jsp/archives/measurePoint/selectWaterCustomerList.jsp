...
<body style="min-width: 800px;">
	<form action="${baseUrl }archives/selectWaterCustomerList.jspx" method="get" id="searchForm">
    ...
    <table class="ymlistTable" width="100%" cellpadding="0" cellspacing="1" >
      ...
      <tr class="listFooterTr">
	  	<td colSpan="9">
			<gdcct:pager id="pagerID" fontPageCSS="currentFont" pageStaticMax="0" pageIndex="${pageModel.pageIndex}" recordCount="${pageModel.recordCount }" pageFirstURL="${baseUrl }archives/selectWaterCustomerList.jspx?pageSize=10" pageDynamicURLFormat="${baseUrl }archives/selectWaterCustomerList.jspx?pageIndex={0}&pageSize=10" pageSize="${pageModel.pageSize}"></gdcct:pager>
		</td>
	  </tr>
    </table>
</body>
