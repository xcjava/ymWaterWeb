			...
			<table class="editTable" border="0" cellspacing="1" cellpadding="10" width="100%" align="center">
				<tbody>
					<tr class="editTr">
						...
						<td class="editRightTd" width="250px">
							<input type="text" id="" name="" value="${waterMeter.userName }" datatype="*" nullmsg="请输入信息！" errormsg="请输入信息！" />
							<span class="Validform_checktip"></span>
						</td>
					</tr>
					<tr class="editTr">
					...
					<tr class="editTr">
						...
						<td class="editLeftTd"><span></span>集中器<span style="color: red;">*</span>：</td>
						<td class="editRightTd" width="250px">
							<input type="text" id="" name="" value="" datatype="*" nullmsg="请输入信息！" errormsg="请输入信息！" />
							<span class="Validform_checktip"></span>
						</td>
					...
					<tr class="editTr">
						<td class="editLeftTd"><span></span>数据类别<span style="color: red;">*</span>：</td>
						<td class="editRightTd" width="250px">
						...
						<td class="editLeftTd"><span></span>脉冲常数<span style="color: red;">*</span>：</td>
						<td class="editRightTd" width="250px">
							<select datatype="*" nullmsg="请输入信息！" errormsg="请输入信息！">
								<option>10</option>
							</select>
					...
					<tr class="editTr">
						...
						<td class="editLeftTd"><span></span>告警量<span style="color: red;">*</span>：</td>
						<td class="editRightTd" width="250px">
							<input type="text" id="" name="" value="" datatype="*" nullmsg="请输入信息！" errormsg="请输入信息！" />
							<span class="Validform_checktip"></span>
						</td>
					...
					<tr class="editTr">
						<td class="editLeftTd"><span></span>无线频率<span style="color: red;">*</span>：</td>
