...
$(function(){
    ...
    $('#exportBtn').click(function(){
    	...
    	var checkPayStatus = $('#checkPayStatus').val();
    	...
    	window.open('${baseUrl }freesettle/downloadWaterDayCostList.jspx?chargingUnitId='+chargingUnitId +'&userId='+userId +'&waterCustomerId='+waterCustomerId 
    			+'&payStatus='+payStatus
