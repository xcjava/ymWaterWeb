	...
	<div id="main">
		<form class="registerform" method="post" enctype="multipart/form-data" action="">
			<table class="editTable" border="0" cellspacing="1" cellpadding="10" width="100%" align="center">
				<tbody>
					<tr class="editTr">
						<td class="editLeftTd"><span></span>任务类型<span style="color: red;">*</span>：</td>
						...
						<td class="editLeftTd"><span></span>任务名称<span style="color: red;">*</span>：</td>
						<td class="editRightTd" width="250px">
					...
					<tr class="editTr">
						<td class="editLeftTd"><span></span>优先级<span style="color: red;">*</span>：</td>
						<td class="editRightTd" width="250px">
							<select datatype="*" nullmsg="请输入信息！" errormsg="请输入信息！">
								<option>1</option>
								<option>2</option>
					...
					<tr class="editTr">
						<td class="editLeftTd"><span></span>执行标志<span style="color: red;">*</span>：</td>
						<td class="editRightTd" width="250px">
							<select datatype="*" nullmsg="请输入信息！" errormsg="请输入信息！">
								<option>暂停</option>
								<option>执行</option>
					...
					<tr class="editTr">
						<td class="editLeftTd"><span></span>任务执行起始时间<span style="color: red;">*</span>：</td>
						<td class="editRightTd" width="250px">
							<input type="text" id="" name="" value="" datatype="*" nullmsg="请输入信息！" errormsg="请输入信息！" />
							<span class="Validform_checktip"></span>
						</td>
						<td class="editLeftTd"><span></span>任务执行结束时间<span style="color: red;">*</span>：</td>
						<td class="editRightTd" width="250px">
							<input type="text" id="" name="" value="" datatype="*" nullmsg="请输入信息！" errormsg="请输入信息！" />
							<span class="Validform_checktip"></span>
						</td>
					...
					<tr class="editTr">
						<td class="editLeftTd"><span></span>任务来源<span style="color: red;">*</span>：</td>
						<td class="editRightTd" colspan="3" >
