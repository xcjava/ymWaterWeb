...
<body style="min-width: 1100px;">
			    ...
			    <table cellSpacing=0 cellPadding=2 border=0>
			      <tbody>
				      ...
				      <tr>
				        ...
				        <td>抄表方式：</td>
				        <td><input class="textbox" id="" style="width: 120px" name="" /></td>
				      	<td><input class="button" id="" type="button" value="日结" name=""></td>
				      	<td><input class="button" id="" type="button" value="实召表码" name=""></td>
    ...
    <table class="ymlistTable" width="100%" cellpadding="0" cellspacing="1" >
      <tr class="listTableHead">
        ...
        <td width=""><div><span>水表模式</span></div></td>
        <td width=""><div><span>中继方式</span></div></td>
        <td width=""><div><span>拉闸功能</span></div></td>
        <td width=""><div><span>闸状态</span></div></td>
        <td width=""><div><span>电池电压</span></div></td>
        <td width=""><div><span>报警状态</span></div></td>
        <td width=""><div><span>操作结果</span></div></td>
        <td width=""><div><span>最新数据</span></div></td>
