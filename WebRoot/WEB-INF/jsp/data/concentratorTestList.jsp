...
<body style="min-width: 1100px;">
    ...
    <table class="ymlistTable" width="100%" cellpadding="0" cellspacing="1" >
      <tr class="listTableHead">
        <td width="" colspan="13">集中器召测列表 </td>
      </tr>
      <tr class="listTableHead">
        ...
        <td width=""><div><span>集中器时间</span></div></td>
        <td width=""><div><span>电表总数</span></div></td>
        <td width=""><div><span>软件版本号</span></div></td>
        <td width=""><div><span>硬件版本号</span></div></td>
        <td width=""><div><span>任务起始时间</span></div></td>
        <td width=""><div><span>任务执行间隔</span></div></td>
        <td width=""><div><span>中继方式</span></div></td>
        <td width=""><div><span>月冻结时</span></div></td>
        <td width=""><div><span>抄收结果</span></div></td>
