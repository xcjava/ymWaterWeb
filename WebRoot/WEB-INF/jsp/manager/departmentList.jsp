...
<body style="min-width: 1100px;">
    ...
    <table class="ymlistTable" width="100%" cellpadding="0" cellspacing="1" >
      ...
      <tr class="listTableTr">
        ...
        <td><div><a href="${baseUrl }manage/departmentDetail.jspx?deptId=${department.deptId }">修改</a> | <a href="${baseUrl }manage/popedomList.jspx?deptId=${department.deptId }">权限</a></div></td>
      </tr>
      </c:forEach>
