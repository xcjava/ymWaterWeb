...
<body style="min-width: 1100px;">
	<table class="position" border="0" cellSpacing="0" cellPadding="0" width="100%" align="center">
		<tbody>
			<tr class="position">
	 			<td class="position">当前位置: 数据查询 -&gt;  日冻结数据查询</td>
	 		</tr>
	 	</tbody>
	</table>	
	<table width="100%" border="0" align="" cellpadding="0" cellspacing="0">
		<tr><td>
			<div class="srhtab">
			    <form id="searchForm" action="${baseUrl }searchAnalysis/freezeDataList.jspx" method="post">
    ...
    <table class="ymlistTable" width="100%" cellpadding="0" cellspacing="1" >
      ...
      <tr class="listTableTr">
        ...
        <td><div>${item.freezeDateStr}</div></td>
