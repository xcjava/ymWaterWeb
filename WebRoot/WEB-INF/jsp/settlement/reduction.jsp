		...
		<form class="registerform" method="post" action="" target="main">
			...
			<table class="editTable" border="0" cellspacing="1" cellpadding="10" width="100%" align="center">
				<tbody>
					...
					<tr class="editTr">
						<td class="editLeftTd"><span></span>减费金额（分）<span style="color: red;">*</span>：</td>
						<td class="editRightTd" width="250px">
							<input type="text" id="price" name="price" value="" datatype="/^\d{1,9}$/" nullmsg="请输入信息！" errormsg="请输入正整数！" />
