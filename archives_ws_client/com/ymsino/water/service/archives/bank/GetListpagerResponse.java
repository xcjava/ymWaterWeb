 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://api.service.archives.esb.ymsino.com/}bankReturn" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetListpagerResponse {
	...
	protected List<BankReturn> _return;
	 ...
	 * 
	 */
	public List<BankReturn> getReturn() {
		if (_return == null) {
			_return = new ArrayList<BankReturn>();
		}
		return this._return;
	}
