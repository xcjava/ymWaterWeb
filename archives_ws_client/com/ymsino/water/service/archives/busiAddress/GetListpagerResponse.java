 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://api.service.archives.esb.ymsino.com/}busiAddressReturn" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetListpagerResponse {
	...
	protected List<BusiAddressReturn> _return;
	 ...
	 * {@link BusiAddressReturn }
	 * 
	 * 
	 */
	public List<BusiAddressReturn> getReturn() {
		if (_return == null) {
			_return = new ArrayList<BusiAddressReturn>();
		}
		return this._return;
	}
