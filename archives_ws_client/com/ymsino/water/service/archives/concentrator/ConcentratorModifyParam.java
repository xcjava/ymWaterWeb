...
/**
 * <p>
 * Java class for concentratorModifyParam complex type.
 * 
 * <p>
 ...
 * 
 * <pre>
 * &lt;complexType name="concentratorModifyParam">
 *   &lt;complexContent>
...
@XmlType(name = "concentratorModifyParam", propOrder = { "actualFlow",
		"address", "algorithmKey", "algorithmNum", "channelId",
		...
		"dayFreezeStartHour", "dayFreezeStartMinute", "district", "exceedFlow",
		"forwardTerminal", "gatewayIp", "gatewayPort", "gprsNum",
		"gpsLatitude", "gpsLongitude", "hardwareId", "heartbeatCycle",
		"meterType", "monthFreezeStartDate", "monthFreezeStartHour", "name",
		"password", "primaryCommPassword", "primaryIp", "primaryPort",
		"proXyIp", "proXyPort", "province", "relaySystem", "relayType",
		"resendTime", "reserveIp", "reservePort", "responseTimeout",
		"rtsClose", "rtsOpen", "rtsTimeout", "serial", "simSN", "smsNum",
		"startTimeout", "startTimestamp", "statuteType", "street", "tel",
...
public class ConcentratorModifyParam {
