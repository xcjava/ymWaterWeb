 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://api.service.archives.esb.ymsino.com/}concentratorReturn" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetListpagerResponse {
	...
	protected List<ConcentratorReturn> _return;
	 ...
	 * {@link ConcentratorReturn }
	 * 
	 * 
	 */
	public List<ConcentratorReturn> getReturn() {
		if (_return == null) {
			_return = new ArrayList<ConcentratorReturn>();
		}
		return this._return;
	}
