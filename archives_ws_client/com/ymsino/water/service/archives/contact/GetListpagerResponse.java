 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://api.service.archives.esb.ymsino.com/}contactReturn" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetListpagerResponse {
	...
	protected List<ContactReturn> _return;
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link ContactReturn }
	 * 
	 * 
	 */
	public List<ContactReturn> getReturn() {
		if (_return == null) {
			_return = new ArrayList<ContactReturn>();
		}
		return this._return;
	}
