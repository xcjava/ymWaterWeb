...
/**
 * This object contains factory methods for each Java content interface and Java element interface generated in the com.ymsino.water.service.archives.contact package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _GetCountResponse_QNAME = new QName("http://api.service.archives.esb.ymsino.com/", "getCountResponse");
	private final static QName _SaveResponse_QNAME = new QName("http://api.service.archives.esb.ymsino.com/", "saveResponse");
	private final static QName _Save_QNAME = new QName("http://api.service.archives.esb.ymsino.com/", "save");
	private final static QName _DeleteResponse_QNAME = new QName("http://api.service.archives.esb.ymsino.com/", "deleteResponse");
	private final static QName _GetCount_QNAME = new QName("http://api.service.archives.esb.ymsino.com/", "getCount");
	private final static QName _GetListpagerResponse_QNAME = new QName("http://api.service.archives.esb.ymsino.com/", "getListpagerResponse");
	private final static QName _GetListpager_QNAME = new QName("http://api.service.archives.esb.ymsino.com/", "getListpager");
	private final static QName _GetByIdResponse_QNAME = new QName("http://api.service.archives.esb.ymsino.com/", "getByIdResponse");
	private final static QName _GetById_QNAME = new QName("http://api.service.archives.esb.ymsino.com/", "getById");
	private final static QName _Modify_QNAME = new QName("http://api.service.archives.esb.ymsino.com/", "modify");
	private final static QName _Delete_QNAME = new QName("http://api.service.archives.esb.ymsino.com/", "delete");
	private final static QName _ModifyResponse_QNAME = new QName("http://api.service.archives.esb.ymsino.com/", "modifyResponse");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ymsino.water.service.archives.contact
	 * 
	 */
	...
	/**
	 * Create an instance of {@link ContactSaveParam }
	 * 
	 */
	public ContactSaveParam createContactSaveParam() {
		return new ContactSaveParam();
	}
	...
	/**
	 * Create an instance of {@link ContactModifyParam }
	 * 
	 */
	public ContactModifyParam createContactModifyParam() {
		return new ContactModifyParam();
	}
	...
	/**
	 * Create an instance of {@link ContactReturn }
	 * 
	 */
	public ContactReturn createContactReturn() {
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://api.service.archives.esb.ymsino.com/", name = "deleteResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://api.service.archives.esb.ymsino.com/", name = "delete")
