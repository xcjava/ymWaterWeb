 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://api.service.archives.esb.ymsino.com/}userReturn" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetListpagerResponse {
	...
	protected List<UserReturn> _return;
	 ...
	 * 
	 */
	public List<UserReturn> getReturn() {
		if (_return == null) {
			_return = new ArrayList<UserReturn>();
		}
		return this._return;
	}
