 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://api.service.archives.esb.ymsino.com/}vatReturn" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetListpagerResponse {
	...
	protected List<VatReturn> _return;
	 ...
	 * 
	 */
	public List<VatReturn> getReturn() {
		if (_return == null) {
			_return = new ArrayList<VatReturn>();
		}
		return this._return;
	}
