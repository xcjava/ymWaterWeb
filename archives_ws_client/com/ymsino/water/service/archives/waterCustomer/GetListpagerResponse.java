 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://api.service.archives.esb.ymsino.com/}waterCustomerReturn" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetListpagerResponse {
	...
	protected List<WaterCustomerReturn> _return;
	 ...
	 * {@link WaterCustomerReturn }
	 * 
	 * 
	 */
	public List<WaterCustomerReturn> getReturn() {
		if (_return == null) {
			_return = new ArrayList<WaterCustomerReturn>();
		}
		return this._return;
	}
