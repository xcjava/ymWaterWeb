...
/**
 * <p>
 * Java class for waterCustomerReturn complex type.
 * 
 * <p>
 ...
 * 
 * <pre>
 * &lt;complexType name="waterCustomerReturn">
 *   &lt;complexContent>
...
@XmlType(name = "waterCustomerReturn", propOrder = { "basicWaterPriceCalc",
		"billType", "busiAddress", "businessType", "category",
		"chargingUnitId", "closeTimestamp", "contractCapacity",
		"createTimestamp", "customNum", "customerId", "customerName",
		"customerStatus", "customerType", "highEnergySectors", "ladderFlag",
		"maturityTimestamp", "meterSegmentNum", "notifyType", "oldUserId",
		"openTimestamp", "parentUnits", "pricStrategyType", "priceTemplateId",
		"remark", "settlementType", "turnForMark", "uid", "userId", "userName",
		"waterNature", "waterPointsName", "waterPointsType",
		"waterPriceIndustry", "withoutWaterMark", "workStatus" })
public class WaterCustomerReturn {
