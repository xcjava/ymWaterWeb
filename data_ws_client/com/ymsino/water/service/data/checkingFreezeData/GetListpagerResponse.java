 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://api.service.data.esb.ymsino.com/}checkingFreezeDataReturn" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetListpagerResponse {
	...
	protected List<CheckingFreezeDataReturn> _return;
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link CheckingFreezeDataReturn }
	 * 
	 * 
	 */
	public List<CheckingFreezeDataReturn> getReturn() {
		if (_return == null) {
			_return = new ArrayList<CheckingFreezeDataReturn>();
		}
		return this._return;
	}
