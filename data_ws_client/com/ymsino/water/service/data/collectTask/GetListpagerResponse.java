 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://api.service.data.esb.ymsino.com/}collectTaskReturn" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetListpagerResponse {
	...
	protected List<CollectTaskReturn> _return;
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link CollectTaskReturn }
	 * 
	 * 
	 */
	public List<CollectTaskReturn> getReturn() {
		if (_return == null) {
			_return = new ArrayList<CollectTaskReturn>();
		}
		return this._return;
	}
