...
/**
 * This object contains factory methods for each Java content interface and Java element interface generated in the com.ymsino.water.service.data.collectTask package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _Save_QNAME = new QName("http://api.service.data.esb.ymsino.com/", "save");
	private final static QName _SaveResponse_QNAME = new QName("http://api.service.data.esb.ymsino.com/", "saveResponse");
	private final static QName _GetByIdResponse_QNAME = new QName("http://api.service.data.esb.ymsino.com/", "getByIdResponse");
	private final static QName _ModifyResponse_QNAME = new QName("http://api.service.data.esb.ymsino.com/", "modifyResponse");
	private final static QName _GetById_QNAME = new QName("http://api.service.data.esb.ymsino.com/", "getById");
	private final static QName _Modify_QNAME = new QName("http://api.service.data.esb.ymsino.com/", "modify");
	...
	/**
	 * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ymsino.water.service.data.collectTask
	 * 
	 */
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://api.service.data.esb.ymsino.com/", name = "save")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://api.service.data.esb.ymsino.com/", name = "saveResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://api.service.data.esb.ymsino.com/", name = "modifyResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://api.service.data.esb.ymsino.com/", name = "modify")
