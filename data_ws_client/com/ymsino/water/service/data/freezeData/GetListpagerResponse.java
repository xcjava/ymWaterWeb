 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://api.service.data.esb.ymsino.com/}freezeDataReturn" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetListpagerResponse {
	...
	protected List<FreezeDataReturn> _return;
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link FreezeDataReturn }
	 * 
	 * 
	 */
	public List<FreezeDataReturn> getReturn() {
		if (_return == null) {
			_return = new ArrayList<FreezeDataReturn>();
		}
		return this._return;
	}
