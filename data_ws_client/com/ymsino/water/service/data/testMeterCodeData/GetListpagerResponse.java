 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://api.service.data.esb.ymsino.com/}testMeterCodeDataReturn" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetListpagerResponse {
	...
	protected List<TestMeterCodeDataReturn> _return;
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link TestMeterCodeDataReturn }
	 * 
	 * 
	 */
	public List<TestMeterCodeDataReturn> getReturn() {
		if (_return == null) {
			_return = new ArrayList<TestMeterCodeDataReturn>();
		}
		return this._return;
	}
