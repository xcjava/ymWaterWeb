 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://api.service.data.esb.ymsino.com/}waterDayUsageAmountReturn" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetListpagerResponse {
	...
	protected List<WaterDayUsageAmountReturn> _return;
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link WaterDayUsageAmountReturn }
	 * 
	 * 
	 */
	public List<WaterDayUsageAmountReturn> getReturn() {
		if (_return == null) {
			_return = new ArrayList<WaterDayUsageAmountReturn>();
		}
		return this._return;
	}
