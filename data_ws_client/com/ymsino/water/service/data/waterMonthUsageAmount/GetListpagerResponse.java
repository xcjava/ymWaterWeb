 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://api.service.data.esb.ymsino.com/}waterMonthUsageAmountReturn" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetListpagerResponse {
	...
	protected List<WaterMonthUsageAmountReturn> _return;
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link WaterMonthUsageAmountReturn }
	 * 
	 * 
	 */
	public List<WaterMonthUsageAmountReturn> getReturn() {
		if (_return == null) {
			_return = new ArrayList<WaterMonthUsageAmountReturn>();
		}
		return this._return;
	}
