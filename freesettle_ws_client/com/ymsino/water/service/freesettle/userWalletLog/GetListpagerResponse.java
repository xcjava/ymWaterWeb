 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://api.service.freesettle.esb.ymsino.com/}userWalletLogReturn" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetListpagerResponse {
	...
	protected List<UserWalletLogReturn> _return;
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link UserWalletLogReturn }
	 * 
	 * 
	 */
	public List<UserWalletLogReturn> getReturn() {
		if (_return == null) {
			_return = new ArrayList<UserWalletLogReturn>();
		}
		return this._return;
	}
