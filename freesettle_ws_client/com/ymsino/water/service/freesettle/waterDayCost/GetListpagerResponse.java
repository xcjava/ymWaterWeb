 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://api.service.freesettle.esb.ymsino.com/}waterDayCostReturn" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetListpagerResponse {
	...
	protected List<WaterDayCostReturn> _return;
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link WaterDayCostReturn }
	 * 
	 * 
	 */
	public List<WaterDayCostReturn> getReturn() {
		if (_return == null) {
			_return = new ArrayList<WaterDayCostReturn>();
		}
		return this._return;
	}
