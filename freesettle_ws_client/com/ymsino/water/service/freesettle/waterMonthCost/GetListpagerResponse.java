 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://api.service.freesettle.esb.ymsino.com/}waterMonthCostReturn" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetListpagerResponse {
	...
	protected List<WaterMonthCostReturn> _return;
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link WaterMonthCostReturn }
	 * 
	 * 
	 */
	public List<WaterMonthCostReturn> getReturn() {
		if (_return == null) {
			_return = new ArrayList<WaterMonthCostReturn>();
		}
		return this._return;
	}
