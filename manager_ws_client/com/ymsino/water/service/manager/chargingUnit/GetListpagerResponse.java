 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://api.service.manager.esb.ymsino.com/}chargingUnitReturn" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetListpagerResponse {
	...
	protected List<ChargingUnitReturn> _return;
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link ChargingUnitReturn }
	 * 
	 * 
	 */
	public List<ChargingUnitReturn> getReturn() {
		if (_return == null) {
			_return = new ArrayList<ChargingUnitReturn>();
		}
		return this._return;
	}
