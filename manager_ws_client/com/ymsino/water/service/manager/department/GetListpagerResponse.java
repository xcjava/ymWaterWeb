 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://api.service.manager.esb.ymsino.com/}departmentReturn" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetListpagerResponse {
	...
	protected List<DepartmentReturn> _return;
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link DepartmentReturn }
	 * 
	 * 
	 */
	public List<DepartmentReturn> getReturn() {
		if (_return == null) {
			_return = new ArrayList<DepartmentReturn>();
		}
		return this._return;
	}
