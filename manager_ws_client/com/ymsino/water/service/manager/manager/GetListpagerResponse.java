 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://api.service.manager.esb.ymsino.com/}managerReturn" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetListpagerResponse {
	...
	protected List<ManagerReturn> _return;
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link ManagerReturn }
	 * 
	 * 
	 */
	public List<ManagerReturn> getReturn() {
		if (_return == null) {
			_return = new ArrayList<ManagerReturn>();
		}
		return this._return;
	}
