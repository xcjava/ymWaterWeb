 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://api.service.manager.esb.ymsino.com/}priceTemplateReturn" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetListpagerResponse {
	...
	protected List<PriceTemplateReturn> _return;
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link PriceTemplateReturn }
	 * 
	 * 
	 */
	public List<PriceTemplateReturn> getReturn() {
		if (_return == null) {
			_return = new ArrayList<PriceTemplateReturn>();
		}
		return this._return;
	}
