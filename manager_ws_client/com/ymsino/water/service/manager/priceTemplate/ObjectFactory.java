...
/**
 * This object contains factory methods for each Java content interface and Java element interface generated in the com.ymsino.water.service.manager.priceTemplate package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _GetById_QNAME = new QName("http://api.service.manager.esb.ymsino.com/", "getById");
	private final static QName _Modify_QNAME = new QName("http://api.service.manager.esb.ymsino.com/", "modify");
	private final static QName _GetByIdResponse_QNAME = new QName("http://api.service.manager.esb.ymsino.com/", "getByIdResponse");
	...
	/**
	 * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ymsino.water.service.manager.priceTemplate
	 * 
	 */
	...
	/**
	 * Create an instance of {@link PriceTemplateModifyParam }
	 * 
	 */
	public PriceTemplateModifyParam createPriceTemplateModifyParam() {
		return new PriceTemplateModifyParam();
	}
	...
	/**
	 * Create an instance of {@link PriceTemplateSaveParam }
	 * 
	 */
	public PriceTemplateSaveParam createPriceTemplateSaveParam() {
		return new PriceTemplateSaveParam();
	}
	...
	/**
	 * Create an instance of {@link PriceTemplateReturn }
	 * 
	 */
	public PriceTemplateReturn createPriceTemplateReturn() {
		return new PriceTemplateReturn();
	}
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://api.service.manager.esb.ymsino.com/", name = "getById")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://api.service.manager.esb.ymsino.com/", name = "getByIdResponse")
