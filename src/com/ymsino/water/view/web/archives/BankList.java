...
public class BankList extends ActionSupport {
    ...
    private List<BankReturn> list = new ArrayList<BankReturn>();
	public String execute() throws Exception{
		...
		list = bankService.getListpager(qpm, pageModel.getStartRow(), pageModel.getPageSize());
		recordCount = bankService.getCount(qpm);
	...
	public List<BankReturn> getList() {
		return list;
	}
