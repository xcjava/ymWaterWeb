...
public class VatList extends ActionSupport {
    ...
    private List<VatReturn> list = new ArrayList<VatReturn>();
	public String execute() throws Exception{
		...
		list = vatService.getListpager(qpm, pageModel.getStartRow(), pageModel.getPageSize());
		recordCount = vatService.getCount(qpm);
