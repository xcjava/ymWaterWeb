...
public class WaterDayUsageAmountList extends ActionSupport {
	...
	public String execute(){
		...
		list = waterDayUsageAmountService.getListpager(qpm,pageModel.getStartRow(), pageModel.getPageSize());
